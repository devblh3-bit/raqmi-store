...
export default async function ResellerLayout({
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 md:flex-row">
      {/* Mobile Top Reseller Header */}
      <div className="flex items-center justify-between rounded-2xl border border-emerald-500/30 bg-[var(--surface)] p-3 shadow-xs md:hidden">
      ...
      <aside className="sticky top-20 self-start hidden w-48 shrink-0 md:block">
        <div className="rounded-2xl border border-emerald-500/30 bg-[var(--surface)] p-4 shadow-sm">
      ...
      <ResellerMobileNav locale={locale} />
    </div>
  );
}
